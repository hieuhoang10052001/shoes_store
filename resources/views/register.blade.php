            ...
            <form id="form-validate">
                ...
                <div class="fieldset">
                    <div class="buttons-set">
                        <p style="font-size:13px;">Tôi đồng ý với các <a href="{{ url('/quy-dinh-su-dung') }}" style="color:#03A9F4;">điều khoản sử dụng</a> của HQ Store và cho phép HQ Store sử dụng thông tin của tôi khi hoàn tất thao tác này.</p>
