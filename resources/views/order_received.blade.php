                                ...
                                <div class="block block-progress opc-block-progress em-line-01">
                                    ...
                                    <div class="block-content" style="border-bottom: 1px solid #ececec;">
                                        ...
                                        @if($order->payment_method == "vnpay")
                                            <strong><span>Thanh toán qua <span style="text-transform: uppercase"> {{$order->payment_method}} </span></span></strong>
                                        @else
                                            <strong><span>Thanh toán <span style="text-transform: uppercase"> {{$order->payment_method}} </span></span></strong>
                                        @endif
                                        </div>
                                    </div>
                                    @if($order->payment_method == "vnpay")
                                    <div class="block-content" style="border-bottom: 1px solid #ececec;">
                                        <div class="col-sm-12">
                                            <strong><span>Trạng thái</span></strong>
                                        </div>
                                        <div class="col-sm-12">
                                        @if($order->is_pay == 1)
                                            <strong><span>Đã thanh toán</span></strong>
                                        @else
                                            <strong><span>Chưa thanh toán</span></strong>
                                        @endif
                                        </div>
                                    </div>
                                    @endif
