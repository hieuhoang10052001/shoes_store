                    ...
                    <div class="col-sm-24 em-col-main">
                        <div class="em_post-item">                           
                            <div class="" style="text-align : justify; padding: 10px 10px; line-height : 30px;">
                                ...
                                <p>Cửa hàng sản phẩm - HQ Store là nơi chuyên cung cấp các sản phẩm cho mọi lứa tuổi.</p>
                                ...
                                <p>Mọi vấn đề thắc mắc, xin liên hệ số điện thoại hotline: 0123 456 789 hoặc gửi thư tới địa chỉ: hqstore@gmail.com</p>
                            </div>
                        </div>
                    </div><!-- /.em-col-main -->
                </div>
