                            ...
                            <form method="post">
                                ...
                                <fieldset>
                                    ...
                                    <table id="shopping-cart-table" class="data-table cart-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="first odd">
                                                ...
                                                <td>
                                                    <a href="{{ url('/san-pham/'.$item['slug']) }}" style="color : #1b74e7; font-size: 16px;"> {{$item['name']}} </a>
                                                    <p class="sku" style="color : #111; font-size: 14px; padding-top: 10px;">Màu: {{$item['color_name']}}</p>
                                                    <p class="sku" style="color : #111; font-size: 13px;">Size: {{$item['size_name']}}</p>
                                    ...
                                    <div style="text-align: center; margin-bottom: 20px;">
                                        <a href="{{ url('/') }}" style="padding : 15px 10px" class="button-continue">
                                            <span><span>Tiếp tục mua hàng</span></span>
                                        </a>
                                    </div>
                                    @endif
                                ...
                                <div class="last totals col-md-16 col-sm-24 right">
                                    <div class="em-box-cart">
                                        <div class="em-box">
                                            ...
                                            <ul class="checkout-types">
                                                <li>
                                                    <button type="button" id ="btn_checkout" class="button btn-checkout" style="font-weight : 500;">
