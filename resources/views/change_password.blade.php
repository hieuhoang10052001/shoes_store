									...
									<div class="em_nav" id="toogle_menu_5_4607">
										<ul class="vnav em-menu-icon effect-menu em-menu-long">
											...
											<li class="menu-item-link menu-item-depth-0 fa fa-recycle">
												<a class="em-menu-link" href="{{ url('/change/password') }}" id="link-change-password">
													<span style="color : #ffffff; border-color: #fdbd8d; background-color: #000000;"> Đổi mật khẩu </span> </a>
											</li><!-- /.menu-item-link -->
										</ul><!-- /.vnav -->
									</div>
