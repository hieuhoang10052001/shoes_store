                        ...
                        <div class="row" style="margin-top : 50px; margin-bottom : 50px;">
                            ...
                            <div class="col-sm-12" style="line-height : 28px; padding-top : 25px;">
                                <div class="em-maps-wrapper" style="margin-b : 25px; padding-bottom : 25px;">
                                    <h1>Cửa hàng sản phẩm HQ Store</h1>
                                </div>

                                <address><span class="fa fa-map-marker secondary2">&nbsp;</span>Địa chỉ: Số 298 đường Cầu Diễn, quận Bắc Từ Liêm, Hà Nội </address>
                                
                                <p class="em-phone"><span class="fa fa-user-md secondary2">&nbsp;</span>Phụ trách chuyên môn: <span class="primary">Hiếu Hoàng</span>
                                </p>

                                <p class="em-phone"><span class="fa fa-phone secondary2">&nbsp;</span>Điện thoại: <span class="primary"> 0123 456 789</span>
                                </p>
                                
                                <p class="em-email"><span class="fa fa-envelope secondary2">&nbsp;</span>Email: <span class="secondary2">hqstore@gmail.com</span>
                                </p>
                            </div><!-- /.col-sm-12 -->
