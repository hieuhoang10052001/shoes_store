...
<head>
    ...
    <meta name="description" content="Đến với mọi cửa hàng của HQ Store, bạn đều được trải nghiệm và mua sắm những sản phẩm chất lượng cao, uy tín hàng đầu trên thị trường chăm sóc sức khỏe">
                                                            ...
                                                            <form id="search_mini_form" method="get" action="{{ url('/search') }}">
                                                                <div class="form-search no_cate_search">
                                                                    <div class="text-search">
                                                                        ...
                                                                        <button type="submit" id="btn_search" title="Search" class="button"><span><span>Tìm kiếm</span></span>
                                                                        </button>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-24">
                                    <div class="em-footer-address">
                                        <address class="f-left">&copy; Bản quyền thuộc về HQ Store</address>
                                    </div>
                                </div>
                            </div>
                        </div>
